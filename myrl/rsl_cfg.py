...
class PPObyolRunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    lr_mult_byol: float = 1.0      # LR multiplier for BYOL params: should be same or faster than base LR
